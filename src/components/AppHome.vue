    ...
    <v-flex xs12 sm6 offset-sm3>
      <v-card>
        <v-img
          class="white--text"
          height="100px"
          src="img/banners/recheck-welcome.jpg"
        >
      ...
      <v-card style="margin-top:1rem">
        <v-img
          class="white--text"
          height="100px"
          src="img/banners/recheck-data.jpg"
        >
          <v-container fill-height fluid>
            <v-layout fill-height>
              <v-flex xs12 align-content-start align-end fill-height flexbox>
        ...
        <v-card-title>
          <div>
            ReCheck servers don't store user credentials. Your identity is entirely owned and controlled by you. Please check your identity details and make sure you back it up.
          </div>
        </v-card-title>
        <v-card-actions>
          <v-spacer></v-spacer>
